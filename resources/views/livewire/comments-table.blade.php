<div>
    <div class="container mt-4 mb-6">
        <div class="row mb-4">
          <div class="col-md-6">
            <input type="text" class="form-control form-control-sm" wire:model.live.debounce.300ms="search" placeholder="Search comments...">
          </div>
          <div class="col-md-2">
        ...
        <table class="table table-bordered table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('comments.edit',[$comment]) }}" class="btn btn-success btn-sm">Edit</a>
              </td>
              <td>
